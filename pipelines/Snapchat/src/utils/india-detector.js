 ...
 * @param {string} [country] - Country field (from Snap API or other source)
 ...
 * Simplified for Snapchat — bio keywords only (no following/follower ratio,
 * since Snapchat doesn't expose following count).
 *
 * @param {string} bio - Creator bio text
